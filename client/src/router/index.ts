...
import ManageInterView from '../views/interview/ManageInterViewView.vue'
import EditInterViewMainView from '../views/interview/EditInterViewMainView.vue'
...
const routes: Array<RouteConfig> = [
  ...
  {
    path: '/inter-view/manage',
    name: 'manageinterview',
    component: ManageInterView
  },
  {
    path: '/inter-view-main/edit/:id',
    name: 'editInterviewmain',
    component: EditInterViewMainView
  }
]
