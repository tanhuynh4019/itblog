<template>
    <div>
        <v-sheet :color="website.color.main">
            <v-container>
                <h2 class="white--text">
                    Thảo luận chuyện nghề nghiệp IT, các thành viên, các tổ chức sẽ cùng bạn thảo luận và cho mọi thứ
                    tốt đẹp hơn
                </h2>
            </v-container>
        </v-sheet>
        <v-sheet class="mt-5" style="height: 1000px;">
            <v-container>
                ...
                <v-row>
                    ...
                    <v-col cols="6">
                        <v-btn depressed dark class="float-end" :color="website.color.main" :to="{name: 'createlifeit'}">Thêm chủ đề</v-btn>
                    </v-col>
                </v-row>
                        ...
                        <v-card :to="{path: `/life-it/eye/${lifeit.slug}`}">
                            <div class="pa-3">
                                <v-list>
                                    <v-list-item>
                                        <v-list-item-avatar>
                                            <img :src="getImageUser(lifeit.author.profile_photo.filename)" :alt="lifeit.author.profile_name">
                                        </v-list-item-avatar>
    ...
    data() {
        return {
            lifeits: [
                ...
                {
                    _id: 2,
                    name: 'Cách tìm và chỉnh sửa thông tin trong file bằng ngôn ngữ C++',
                    content: ' mình đang làm bài tập kiểu nhập danh sách khác hàng vào danh sách, tìm tên và chỉnh sửa tên khách hàng trong file, mà mình đang bí, có cáo',
                    tags: ['Lỗi'],
                    commentCount: 2,
                    author: {
                        profile_name: 'tanhuynh9940',
